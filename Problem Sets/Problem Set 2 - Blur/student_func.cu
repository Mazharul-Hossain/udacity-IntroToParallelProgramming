// Homework 2: https://github.com/udacity/cs344/blob/master/Problem%20Sets/Problem%20Set%202/student_func.cu
// Image Blurring
//
...
__global__ void gaussian_blur_noshared(const unsigned char *const inputChannel,
                        ...
                        const int filterWidth)
{
    ...
    const dim3 blockSize(BLOCK_SIZE_X, BLOCK_SIZE_Y, 1); // TODO
    ...
    unsigned int gridRow = (unsigned int)((numCols / BLOCK_SIZE_X) + 1);
    unsigned int gridCol = (unsigned int)((numRows / BLOCK_SIZE_Y) + 1);
